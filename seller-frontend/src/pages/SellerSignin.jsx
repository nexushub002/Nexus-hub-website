          ...
          <div className="space-y-6">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="flex items-center justify-between mb-4">
                <span className="text-blue-100">Your Dashboard Awaits</span>
                <span className="text-2xl">📊</span>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-sm text-blue-200">Orders Today</span>
                  <span className="text-white font-semibold">+12</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-blue-200">Revenue This Month</span>
                  <span className="text-white font-semibold">₹45,000</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-sm text-blue-200">Active Products</span>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="mt-8 mb-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to NexusHub?</span>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/seller-signup" className="text-blue-600 hover:text-blue-700 font-medium">
                Create one now
              </Link>
            </p>
          </div>
